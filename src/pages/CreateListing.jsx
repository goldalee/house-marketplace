...
function CreateListing(){
  ...
  return ()=>{
      //esling disable this line react-hoos 
...
/*
 // `https://maps.googleapis.com/maps/api/geocode/json?
            //address=${address}&key=AIzaSyCbGwvQ14uD9YOVNqW0jbP2pv79pC5AkWI`
*/
...
const onMutate = e =>{
   ...
   //?? e.nullish character if the value on the left is null use the right side
    if(!e.target.files){
        setFormData((prevState)=>({
            ...prevState,
...
<div className='profile'>
    ...
    <input
        ...
        required
        />
        <button type='submit' className='primaryButton' id="createListingButton">Create Listing
        </button>
        </form>
    </main>
</div>   
