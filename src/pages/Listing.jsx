...
function Listing () {
    ...
    const [sharedLinkeCopied, setSharedLinkCopied]=useState(false)
  ...
  return (
    ...
    {sharedLinkeCopied && <p className='linkCopied'>Link Copied!</p>}
...
//stackoverflow/questions/67552020/how-to-fix-error-failed-to-compile-node-modules-react-leaflet-core-esm-pat